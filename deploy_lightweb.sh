...
if [[ "$unamestr" == 'Linux' ]]; then
   ...
   prod_domain=$(dialog --title 'LightWeb 3.0.28' --inputbox 'Enter your production domain' 0 0  --output-fd 1)
   images_server=$(dialog --title 'LightWeb 3.0.28' --inputbox 'Enter your images host (images.mycompany.com)' 0 0  --output-fd 1)
   ...
   webname=$(dialog --title 'LightWeb 3.0.28' --inputbox 'What is the name of your website' 0 0  --output-fd 1) 
   company=$(dialog --title 'LightWeb 3.0.28' --inputbox 'Company' 0 0  --output-fd 1)
   telephone=$(dialog --title 'LightWeb 3.0.28' --inputbox 'Telephone' 0 0  --output-fd 1)
   background_color=$(dialog --title 'LightWeb 3.0.28' --inputbox 'Background Color HEX' 0 0  --output-fd 1)
   theme_color=$(dialog --title 'LightWeb 3.0.28' --inputbox 'Theme Color HEX' 0 0  --output-fd 1)
    mkdir -p $domain;
    echo -ne '#                         (  0%)\r'
    sleep 1
