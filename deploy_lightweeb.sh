...
if [[ "$unamestr" == 'Linux' ]]; then
   ...
   clear
   domain=$(dialog --title 'LightWeeb 3.0.33' --inputbox 'Enter your staging domain' 0 0  --output-fd 1)
   prod_domain=$(dialog --title 'LightWeeb 3.0.33' --inputbox 'Enter your production domain' 0 0  --output-fd 1)
   images_server=$(dialog --title 'LightWeeb 3.0.33' --inputbox 'Enter your images host (images.mycompany.com)' 0 0  --output-fd 1)
   ...
   webname=$(dialog --title 'LightWeeb 3.0.33' --inputbox 'What is the name of your website' 0 0  --output-fd 1) 
   company=$(dialog --title 'LightWeeb 3.0.33' --inputbox 'Company' 0 0  --output-fd 1)
   telephone=$(dialog --title 'LightWeeb 3.0.33' --inputbox 'Telephone' 0 0  --output-fd 1)
   background_color=$(dialog --title 'LightWeeb 3.0.33' --inputbox 'Background Color HEX' 0 0  --output-fd 1)
   theme_color=$(dialog --title 'LightWeeb 3.0.33' --inputbox 'Theme Color HEX' 0 0  --output-fd 1)
    mkdir -p $domain;
    echo -ne '#                         (  0%)\r'
    sleep 1
    wget -q https://github.com/ruvenss/lightweb/archive/refs/tags/3.0.33.zip -O "lightweeb.zip"
    echo -ne '#####                     ( 20%)\r'
    sleep 1
    unzip -qq ./"lightweeb.zip" && rm ./"lightweeb.zip"
    echo -ne '###########               ( 40%)\r'
    sleep 1
    sudo cp -aRf lightweeb-3.0.33/. $domain
    sudo rm -rf lightweeb-3.0.33
    chmod 777 $domain
    echo -ne '#################         ( 60%)\r'
    sleep 1
   ...
   domain=$(dialog --title 'LightWeeb 3.0.33' --inputbox 'Enter your staging domain' 0 0  --output-fd 1)
    ...
    find 2>/dev/null |while read f;
    do
        sudo cp -aRf lightweb-3.0.33/. $domain
        sudo rm -rf lightweb-3.0.33
        chmod 777 $domain
        sleep 1
